...
const discussions: Discussion[] = [
  {
    id: '1',
    title: 'WiFi connectivity issues in dormitory blocks',
    content: 'The WiFi connection has been very unstable in the dormitory blocks, especially during evening hours. This is affecting our online classes and assignments. Can the IT department look into this?',
    author: 'StudentA2024',
    category: 'facilities',
    priority: 'high',
    date: '2024-02-28',
  ...
  },
  {
    ...
    content: 'Many students are requesting extended library hours during the upcoming exam period. The current 9 PM closing time is insufficient for proper study preparation.',
    author: 'StudyGroup2024',
    category: 'academic',
    priority: 'medium',
    date: '2024-02-27',
    likes: 15,
  ...
  {
    id: '3',
    title: 'Parking shortage near science building',
    content: 'There are insufficient parking spaces near the science building, especially during peak hours. Students often have to park very far and walk long distances.',
