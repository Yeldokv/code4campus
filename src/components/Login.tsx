...
import aboutImg from '../assets/aaa.jpg'; // <-- Import image
...
return (
  <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 flex items-center justify-center px-4 relative">
    {/* Background Image */}
    <div
      ...
      style={{
        ...
        opacity: 0.7, // clearer image (increase to 0.8–1 if you want it brighter)
      }}
    ></div>
    ...
    <div className="relative w-full max-w-md">
      <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-gray-700">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300">Sign in to access campus services</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-700/80 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
